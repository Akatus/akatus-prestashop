...
class AkatusD extends PaymentModule
{
	...
	public function __construct()
    {
        ...
        $this->displayName 		= $this->l('Akatus - TEF / Cartão de Débito');
        $this->description 		= $this->l('Permite receber pagamentos Cartão de Débito / Transferência Eletrônica através do gateway Akatus');
	...
	{
		$this->_html .= '
		<img src="../modules/akatusd/imagens/akatus.jpg" style="float:left; margin-right:15px;" />
		<b>'.$this->l('Este módulo permite aceitar pagamentos com Cartão de Débito (TEF) via Akatus.').'</b><br /><br />
		'.$this->l('Se o cliente escolher esse módulo de pagamento, ele poderá pagar a compra utilizando seu cartão de débito via transferência bancária.').'<br />
	...
	public function hookPayment($params)
	{
		...
		global $smarty;
		$smarty->assign(array(
			'imgBtn' => "modules/akatusd/imagens/tef_akatus.jpg",
