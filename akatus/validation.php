...
$endereco = mysql_query('
	...
	*/
	...
	else if($aka['resposta']['status'] == 'Em Análise' or $aka['resposta']['status'] == 'Em AnÃ¡lise' or $aka['resposta']['status'] == 'Em Analise')
	{
	...
	else if($aka['resposta']['status'] == 'Cancelado')
	{
	...
	else if ($aka['resposta']['status']=='Aprovado')
	{
